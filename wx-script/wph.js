...
class Task {
    ...
    saveCache() {
        ...
        cache[this.cacheId] = {
            ...(cache[this.cacheId] || {}),
            token: this.token || (cache[this.cacheId] || {}).token || "",
            userId: this.userId || (cache[this.cacheId] || {}).userId || "",
            vipOpenid: this.vipOpenid || (cache[this.cacheId] || {}).vipOpenid || "",
            unionid: this.unionid || (cache[this.cacheId] || {}).unionid || "",
    ...
    removeLoginCache() {
        ...
        if (cache[this.cacheId]) {
            delete cache[this.cacheId].token;
            delete cache[this.cacheId].userId;
            writeCache(cache);
        }
    }
    async login() {
